...
public class StructureData
{
    public static final int[] DRAWABLES = {
        0, // No structure
        R.drawable.ic_building1, R.drawable.ic_building2,
            R.drawable.ic_building3,
            R.drawable.ic_building4,
            R.drawable.ic_building5, R.drawable.ic_building6, R.drawable.ic_building7, R.drawable.ic_building8,
    ...
    private List<Structure> structureList = Arrays.asList(new Structure[] {
        ...
        new Structure(R.drawable.ic_building2, "House2"),
            new Structure(R.drawable.ic_building3, "House3"),
            new Structure(R.drawable.ic_building4, "House4"),
            new Structure(R.drawable.ic_building5, "House5"),
            new Structure(R.drawable.ic_building6, "House6"),
            new Structure(R.drawable.ic_building7, "House7"),
            new Structure(R.drawable.ic_building8, "House8"),
